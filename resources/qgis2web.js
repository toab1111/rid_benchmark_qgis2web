...
map.getView().fit([11186599.159014, 1681214.562907, 11214989.378940, 1705093.877606], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">RID BENCHMARK MAP</h2>';
        return titleElement;
    })(),
